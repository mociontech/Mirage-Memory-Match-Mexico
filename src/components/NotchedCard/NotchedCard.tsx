...
/**
 * The white panel reused on Felicidades and the Top 5 ranking: rounded on
 * two corners, squared off with a small red tab on the other two - Figma's
 * "ticket stub" card. The tabs are plain CSS rectangles, not the original
 * vector asset (Figma doesn't expose it as a separate node to export).
 */
